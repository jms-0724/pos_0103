              ...
              <div class="form-group my-3">
                ...
                <div class="modal-footer">
                    ...
                    <!-- <button type="submit" class="btn btn-primary">Save Entry</button> -->
                        <button type="button" class="btn btn-primary mx-2" id="saveEntry">Save Entry</button>
                        <button type="reset" class="btn btn-danger mx-2">Clear</button>
                        <button type="button" class="btn btn-primary mx-2" data-bs-dismiss="modal" id="close1">Close</button>
                    </div>
                </div>
