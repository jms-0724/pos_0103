      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="d-flex justify-content-center">
            ...
            <button type="button" class="btn text-white" style="background-color:#0e2238;" id="proceedArchive">Yes</button>
            <button type="button" class="btn mx-2 text-white" style="background-color:#004d68;" data-bs-dismiss="modal" id="backArchive">No</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="d-flex justify-content-center">
            ...
            <button type="button" class="btn mx-2 text-white" style="background-color:#004d68;" data-bs-dismiss="modal" id="backUpdate">No</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="d-flex justify-content-center">
            ...
            <button type="button" class="btn mx-2 text-white" style="background-color:#004d68;" data-bs-dismiss="modal" id="backUpdate2">No</button>
          </div>
        </div>
      </div>
    </div>
