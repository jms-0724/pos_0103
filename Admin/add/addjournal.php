...
if (isset($jsondecoded['add_journal_number'])) {
    ...
    try {
        ...
        $sql1 = $conn->prepare("INSERT INTO tbl_journal_entry (journal_voucher_no, journal_date, description, category_id, uid, fiscal_id) VALUES (:journal_voucher_no, :journal_date, :description, :category_id, :uid, :fiscal_id)");
